...
namespace Windtalker.Plumbing.Auth
{
    ...
    {
        public JwtTokenAuthenticationOptions(string issuer = null,
        ...
        /// <summary>
        ///     The Issuer of the JWT token - grab a token (https://docs.auth0.com/protocols) and use https://jwt.io to see the
        ///     issuer
        /// </summary>
